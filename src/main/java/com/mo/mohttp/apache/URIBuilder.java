...
public final class URIBuilder {
    ...
    private void digestURI(final URI uri) {
        ...
        this.queryParams = parseQuery(uri.getRawQuery(), this.charset != null ? this.charset : Charset.forName("UTF-8"));
        this.encodedFragment = uri.getRawFragment();
        this.fragment = uri.getFragment();
    }

    private String encodeUserInfo(final String userInfo) {
        return URLEncodedUtils.encUserInfo(userInfo, this.charset != null ? this.charset : Charset.forName("UTF-8"));
    }

    private String encodePath(final String path) {
        return URLEncodedUtils.encPath(path, this.charset != null ? this.charset : Charset.forName("UTF-8"));
    }

    private String encodeUrlForm(final List<NameValuePair> params) {
        return URLEncodedUtils.format(params, this.charset != null ? this.charset : Charset.forName("UTF-8"));
    }

    private String encodeUric(final String fragment) {
        return URLEncodedUtils.encUric(fragment, this.charset != null ? this.charset : Charset.forName("UTF-8"));
    }
    ...
    public URIBuilder setQuery(final String query) {
        this.queryParams = parseQuery(query, this.charset != null ? this.charset : Charset.forName("UTF-8"));
        this.query = null;
        this.encodedQuery = null;
        this.encodedSchemeSpecificPart = null;
        return this;
